...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the correct physical mechanism of lift generation. Address why the equal-transit-time argument fails, and tie your explanation to circulation and the Kutta condition.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain what stall is in terms of angle of attack and boundary-layer behavior, and why a wing can stall at high airspeed. Why is angle of attack, not airspeed, the true determinant of stall?",
      ...
      {
        prompt: "Part 2: Now the constraints change. The design team wants the wing to stall at the root before the tip (so ailerons stay effective and the aircraft remains controllable in the stall). What design features achieve this, and what is the aerodynamic risk if instead the tips stall first?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Distinguish induced drag from parasitic drag, including how each scales with airspeed and with lift. Explain why reducing wingspan is the wrong move at low-speed, high-lift conditions.",
      ...
      {
        prompt: "Part 2: Now the constraints change. The aircraft will spend almost its entire mission cruising at high subsonic speed and high altitude, and gate-span limits cap the wingspan. Given fixed span, what aerodynamic and configuration choices reduce cruise drag, and what tradeoffs do winglets introduce?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain why sweeping the wing benefits a transonic cruise aircraft. Use the idea of the component of the freestream normal to the wing and the critical/drag-divergence Mach number.",
      ...
      {
        prompt: "Part 2: Now the constraints change. Sweep is not free. Describe the penalties swept wings introduce at low speed and structurally, including spanwise flow and tip stall, and explain why a low-speed STOL or trainer aircraft typically uses a straight wing instead.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the difference between the attached oblique shock at the sharp nose and the detached normal (bow) shock ahead of the blunt body. Describe what happens to Mach number, pressure, and total pressure across each, and why this matters for wave drag.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the difference between laminar and turbulent boundary layers in terms of skin friction and resistance to separation, and explain how this resolves the apparent paradox that earlier transition can reduce total drag. Tie this back to maximizing L/D.",
