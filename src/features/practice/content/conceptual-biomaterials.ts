...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Make the case for titanium. Why is Ti-6Al-4V attractive for a load-bearing, cementless hip stem compared with 316L stainless and CoCrMo? Address the body environment specifically.",
      ...
      {
        prompt: "Now the constraints change. The same alloy is proposed for the femoral head that articulates against a polyethylene cup. Should you keep Ti-6Al-4V there, and what changes your reasoning?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain mechanistically why the bone weakened, linking modulus mismatch to the biological response. Why does a stiffer plate make this worse?",
      ...
      {
        prompt: "Now the constraints change. You may not change the plate geometry envelope, but you can change material and you must still provide enough initial stability to heal the fracture. What design and material strategies reduce stress shielding without compromising early healing?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Compare the design philosophies of a permanent versus a degradable implant for this case. What are the engineering and clinical arguments for choosing the resorbable screw, and how is the material designed to disappear safely?",
      ...
      {
        prompt: "Now the constraints change. Post-market data show some PLA screws cause a delayed inflammatory reaction and sterile fluid collections (cysts) months after implantation. Explain what likely went wrong with the degradation behavior and how you would re-engineer it.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the corrosion mechanisms at play. Why does a metal junction inside the body corrode even when each alloy is individually passive and corrosion-resistant, and why is a dissimilar-metal junction especially vulnerable?",
      ...
      {
        prompt: "Now the constraints change. Marketing insists on keeping the device modular for intraoperative flexibility, so you cannot make it a single monolithic part. What material, surface, and design measures would you use to suppress the corrosion while keeping modularity?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain how the sterilization method, not just the base material, caused the failure. What does gamma irradiation in air do to UHMWPE over time?",
      ...
      {
        prompt: "Now the constraints change. You must still sterilize and you want to exploit radiation crosslinking to improve wear resistance, but eliminate the oxidative embrittlement. What process changes achieve this, and what new tradeoff do you introduce?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain why a static test passing does not guarantee survival in the body. What is the loading environment that drives fatigue failure of a vascular implant, and roughly how many cycles must it survive?",
      ...
      {
        prompt: "Now the constraints change. The vessel sits across a flexing joint (e.g. the femoropopliteal artery), adding large bending and torsion to the pulsatile load. How does this change your material/design approach, and why is Nitinol used here in particular?",
