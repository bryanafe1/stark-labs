...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Part 1: To find the velocity of the latched pair immediately after impact, which method do you reach for, and why are the other two methods poor choices for that specific step?",
      ...
      {
        prompt: "Part 2: Now the constraints change -- instead of latching, the carts collide through an elastic spring bumper between them (no latch, they may separate), and you want the maximum bumper compression. Which method now, and what changes in your reasoning?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Assuming both roll without slipping, which reaches the bottom first and why? Address the common misconception that mass or radius decides it.",
      ...
      {
        prompt: "Part 2: Now the constraints change -- the incline is coated with ice so friction is essentially zero. What happens to each body, and how does the race change?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain physically why turning the vehicle produces a moment on the rotor bearings, and in which plane that reaction moment acts. Use the relationship between applied torque, spin, and precession.",
      ...
      {
        prompt: "Part 2: Now the constraints change -- you may add a second identical rotor to reduce these gyroscopic bearing loads. How should you configure it, and what is the trade-off?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Using the impulse-momentum theorem, explain why the foam dramatically reduces the peak force on the package even though the change in momentum is identical in both cases.",
      ...
      {
        prompt: "Part 2: Now the constraints change -- a colleague suggests a stiff steel spring instead of foam, sized so the package just barely comes to rest at full compression. Does the spring protect the contents as well as the foam? Discuss force-time profile and rebound.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Diagnose the likely cause and explain the resonance/transmissibility reasoning. How does the ratio of operating frequency to the mount natural frequency govern how much force reaches the floor?",
      ...
      {
        prompt: "Part 2: Now the constraints change -- the compressor must run over a WIDE range of speeds, including passing slowly through the mount natural frequency on startup, so a single soft mount cannot avoid resonance at all speeds. What design strategies address this?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: What happens to the spin rate as the boom retracts, and is energy conserved in this process? Reconcile angular momentum conservation with the change in rotational kinetic energy.",
      ...
      {
        prompt: "Part 2: Now the constraints change -- instead of an internal motor retracting the boom, a small thruster on the payload fires to push it inward. Does angular momentum still stay constant, and how does your energy accounting change?",
