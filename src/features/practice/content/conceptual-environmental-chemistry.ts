...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Explain what BOD and COD each measure, why BOD5 can be high while COD is low for the same sample, and physically why the DO sag forms downstream rather than right at the outfall.",
      ...
      {
        prompt: "Now the constraints change. The river flow drops sharply during a summer drought and water temperature rises by 10 C. Qualitatively, how do these two changes move the DO sag and its minimum value, and why?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the eutrophication mechanism that links nutrient loading to the late-summer fish kills, identify the likely limiting nutrient here and why, and explain why phosphate is so low during the bloom.",
      ...
      {
        prompt: "Now the constraints change. The lake bottom goes anoxic and stays anoxic for weeks. Explain how anoxia at the sediment-water interface can release stored phosphorus back into the water (internal loading) and why this makes the lake resistant to recovery even after external farm runoff is reduced.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Define alkalinity, explain the role of the carbonate system (CO2/H2CO3, HCO3-, CO3 2-) in buffering pH, and explain why the limestone lake resists acidification while the granite lake does not.",
      ...
      {
        prompt: "Now the constraints change. Suppose the granite lake also becomes acidic enough to mobilize aluminum from soils and sediments. Explain why low pH releases aluminum, why this is especially harmful to fish, and how it compounds the acidification problem.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain what Kow and Koc represent and how they relate, then predict where each compound ends up (water column, sediment, biota) and how each spreads downstream. Explain why the high-Kow compound bioaccumulates.",
      ...
      {
        prompt: "Now the constraints change. A flood scours and resuspends the contaminated bottom sediments years later, and the river water is unusually warm and rich in dissolved organic matter (DOM). Explain how these changes can remobilize compound A and alter its bioavailability and transport.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Set up the mass-balance reasoning for a well-mixed lake (in words and a plain-text equation), define the hydraulic residence time, and explain conceptually what determines the steady-state concentration of a conservative pollutant and how fast the lake approaches it.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the main processes governing contaminant transport in the aquifer (advection, dispersion, sorption/retardation, and degradation) and use them to explain why the plume arrives later, more dilute, and with a smeared front than pure advection predicts.",
