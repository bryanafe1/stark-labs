...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Explain why the static pressure is lower at the nozzle exit than inside the hose, even though the same mass of water flows through both. Walk through how continuity and Bernoulli together explain the speed and pressure change.",
      ...
      {
        prompt: "Now suppose the nozzle is partially clogged with mineral scale so the flow through it becomes highly viscous and dominated by friction. Does Bernoulli still predict the pressure relationship correctly, and how does your reasoning change?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain physically what the Reynolds number represents and why the same flow rate can be laminar for one fluid and turbulent for the other. Identify which fluid is more likely to be turbulent.",
      ...
      {
        prompt: "Now the engineer heats the oil substantially before pumping it. What happens to its flow regime and to the friction pressure drop, and why is the direction of the friction change not obvious?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain how boundary layer separation produces pressure (form) drag on a sphere, and why making the boundary layer turbulent with dimples can reduce total drag despite increasing skin friction.",
      ...
      {
        prompt: "Now consider a long, streamlined airfoil shape instead of a sphere, operating at low angle of attack. Would adding dimples or tripping the boundary layer turbulent help or hurt drag, and why does the answer flip?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain what cavitation is, why it is occurring at the pump suction, and how the concept of Net Positive Suction Head (NPSH available vs required) frames whether cavitation will happen.",
      ...
      {
        prompt: "Now identify why this is worse on a hot afternoon, and give two distinct changes to the installation (not the pump itself) that would raise NPSH available. Justify each from the NPSH equation.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain why a smaller pipe at the same flow rate dramatically increases frictional head loss and pumping cost. Use the Darcy-Weisbach relationship to show how strongly head loss depends on diameter.",
      ...
      {
        prompt: "Now the same line must instead carry a fixed flow of a very viscous fluid in the laminar regime. Does the strong diameter sensitivity still hold, and how does the friction physics differ from the turbulent water case?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Give a physically correct explanation of how an airfoil generates lift, addressing why the equal-transit-time argument is wrong and how circulation, the Kutta condition, and the pressure field relate to the lift force.",
      ...
      {
        prompt: "Now the pilot keeps increasing the angle of attack past a critical value and the wing suddenly stalls, losing lift. Explain in boundary-layer terms what changed, and why lift can drop even though the angle of attack is larger.",
