...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Explain how the rising water table changes the effective stress at the bottom of the clay layer. Walk through the relationship between total stress, pore water pressure, and effective stress (sigma_prime = sigma - u).",
      ...
      {
        prompt: "Now suppose instead the river is dammed and the water table is permanently lowered by pumping (dewatering) by 3 m. What happens to effective stress and what long-term ground behavior would you warn the client about?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the mechanism of primary consolidation. Why does settlement in saturated clay continue long after the load is applied, and what controls the rate?",
      ...
      {
        prompt: "Now the schedule demands the settlement be largely finished before paving. What design measures would you propose to speed up consolidation, and why do they work?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the difference between a bearing capacity (strength) failure and a settlement (serviceability) failure for a shallow footing, and why both must be checked.",
      ...
      {
        prompt: "Now the same column load must be supported on soft saturated clay instead of sand, and the load includes a large sustained portion. How does your analysis change, and what governs the design?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the mechanism of liquefaction in terms of effective stress and pore pressure. Why does loose saturated sand lose its strength during cyclic earthquake shaking, and why is drainage central to the problem?",
      ...
      {
        prompt: "Now consider the same shaking applied to a dense, dilative sand and to a saturated clay. Explain why each is far less prone to classic liquefaction, and what mitigation you would specify for the loose sand site.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the difference between at-rest, active, and passive earth pressure. Which one acts on the back of a yielding cantilever wall, and why does wall movement determine the pressure?",
      ...
      {
        prompt: "Now the drains clog and the backfill becomes saturated after heavy rain. Explain quantitatively why this is dangerous and how it changes the loading on the wall.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Using the Mohr-Coulomb model tau = c + sigma_prime tan phi, explain the physical difference between the cohesion term and the friction term, and why a clean sand is treated as purely frictional while clay can have apparent cohesion.",
      ...
      {
        prompt: "Now distinguish the drained versus undrained strength of the clay slope. Why might a clay cut be stable right after excavation but fail months later, while a different clay failure happens during rapid loading?",
