...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Part 1: Compare casting, forging, and machining-from-billet for this bracket. Given the load profile (high cyclic / fatigue) and the modest, uncertain volume, which would you pick and why? Address tooling cost, lead time, and mechanical properties.",
      ...
      {
        prompt: "Part 2: Now the constraints change. The program is greenlit for 50,000 units per year and the design is frozen. Does your recommendation change, and what new design or process steps would you add to maximize fatigue life at this volume?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the root cause of both the bowing and the delayed cracking in terms of welding thermal cycles. Why does residual stress arise, and how can locked-in stress cause a crack with no external load?",
      ...
      {
        prompt: "Part 2: Now the constraints change. You cannot redesign the joint geometry and the alloy is fixed, but you control welding sequence, fixturing, preheat, and post-processing. What practical measures reduce distortion and prevent the delayed cracking, and what is the tradeoff of each?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain why tightening tolerance and surface finish drives cost up so sharply (roughly exponentially), referencing the process chain. When is a tight tolerance genuinely justified versus over-specified?",
      ...
      {
        prompt: "Part 2: Now the constraints change. Only the two bearing journals actually need precision; the rest of the shaft just needs to clear surrounding parts. How would you re-specify the drawing, and how does tolerance stack-up and datum/GD&T strategy factor into hitting the assembly fit?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Compare metal additive (e.g., powder-bed fusion) against subtractive machining for this manifold. What does additive enable here that machining cannot, and what are additive's real drawbacks regarding properties, surface finish, and cost?",
      ...
      {
        prompt: "Part 2: Now the constraints change. The internal passages have a hard cleanliness and surface-roughness requirement, and the sealing faces must be flat and precise. What hybrid workflow and design-for-AM choices let you keep the additive benefit while meeting these requirements?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Walk through the design-for-manufacturing problems with this part. Why are draft angles, uniform wall thickness, and avoiding thick sections so important in injection molding? Tie each issue to a specific defect.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain why a process that is ideal for prototypes (CNC machining, laser cutting, manual bending) is usually the wrong choice for mass production. Frame it in terms of fixed (tooling) cost versus variable (per-part) cost and the resulting break-even logic.",
      ...
      {
        prompt: "Part 2: Now the constraints change. The team commits to stamping for the high-volume panel. What geometry and design-for-manufacturing changes must the part undergo to suit stamping rather than machining, and what new failure modes must they design against?",
