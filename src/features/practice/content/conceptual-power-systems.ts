...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Explain why historically AC beat DC for long-distance transmission. Tie your answer to how AC enables voltage transformation and why operating at high voltage matters for moving power over distance.",
      ...
      {
        prompt: "Now the constraints change. The modern answer is no longer 'always AC.' For a 1000 km undersea cable link or a very long point-to-point overhead interconnection, engineers increasingly choose HVDC. Why does the original AC-wins logic break down here, and what does HVDC buy you?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the distinction between real power, reactive power, and apparent power, why induction motors create a lagging power factor, and why a low power factor costs both the utility and the plant money even though reactive power does no net work.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the main engineering advantages of a balanced three-phase system over single-phase: constant instantaneous power delivery, the rotating magnetic field for motors, and conductor/copper efficiency. Be concrete about why these fall out of having three voltages 120 degrees apart.",
      ...
      {
        prompt: "Now the constraints change. The plant develops a badly unbalanced load (one phase loaded far more than the others) and someone removes the neutral connection on a four-wire system. Explain what goes wrong electrically and why balance matters so much, contrasting it with the ideal balanced case.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain physically why voltage drops along a loaded feeder, why both the resistance and the reactance of the line matter, and why the problem is worst at the far end during heavy load and for loads with poor (lagging) power factor.",
