...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Using the momentum picture of thrust, explain where thrust comes from and why the engineer's claim is an oversimplification. Be specific about the two levers available to a designer.",
      ...
      {
        prompt: "Now the constraints change. The mission is reweighted so that propulsive efficiency and fuel burn at high subsonic cruise speed dominate the design, not raw thrust. Which lever should the designer favor now, and why does that push toward a high-bypass turbofan rather than a turbojet?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain physically what specific impulse measures and why thrust and Isp are not the same thing. Why can one engine win on thrust while the other wins on Isp?",
      ...
      {
        prompt: "Now the constraints change. Consider two mission segments: (a) lifting a heavy vehicle off the launch pad against gravity, and (b) a long deep-space transfer where total propellant mass is the binding constraint. For each segment, which engine matters more and why? Tie it to the rocket equation.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain why a purely converging nozzle cannot accelerate the exhaust past the speed of sound, and why a diverging section is required to reach supersonic exit velocity. Reference what happens at the throat.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the phenomenon of choked flow. Why does the mass flow rate stop increasing once the flow chokes, even as downstream pressure keeps dropping?",
      ...
      {
        prompt: "Now the constraints change. To get more mass flow through a choked throat, a colleague proposes simply opening a downstream valve wider. Explain why that fails, and describe what you would actually change (upstream conditions or geometry) and how each affects mdot.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the fundamental difference between a rocket and an airbreathing engine in terms of what they carry and where they get their working fluid and oxidizer. Why does an airbreather typically achieve much higher Isp in the atmosphere?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain how a turbofan works at a high level (core versus bypass flow) and why high bypass ratio improves fuel efficiency at subsonic cruise. Connect your reasoning to propulsive efficiency.",
      ...
      {
        prompt: "Now the constraints change. The same logic is applied to a supersonic fighter that must dash at high Mach and prize thrust-to-weight and frontal area over cruise fuel economy. Explain why a high-bypass turbofan is the wrong choice there and what architecture is favored instead.",
