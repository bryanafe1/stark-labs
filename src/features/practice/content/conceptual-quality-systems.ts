...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Part 1: Is this common cause or special cause variation, and how do you decide? Walk through what you would actually do at the line before changing anything about the process.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: How can Cp look excellent while real parts fall out of spec? Explain the difference between Cp and Cpk and which one the supplier should have been reporting.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the principle that you cannot inspect quality into a product. Why did adding inspection stations fail to fix the escape rate, and what does this say about where quality is actually created?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: The team treats the seized bearing as the root cause. Explain why that is likely a symptom rather than the root cause, and how a structured method such as 5 Whys or a fishbone analysis would push the investigation deeper.",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the relationship between sample size, confidence, and the precision of the estimate. Why does a low expected defect rate make small samples especially weak, and what does finding zero defects in 30 parts actually let you conclude?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: How can every part be in spec while the assembly is out of spec? Explain tolerance stack-up, and contrast worst-case stacking with a statistical (RSS) approach to how the individual tolerances combine.",
