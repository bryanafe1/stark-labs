...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "For this positive-order reaction at high conversion, would a single CSTR or a single PFR require less volume to reach the target conversion, and why? Frame your reasoning in terms of how concentration (and therefore rate) varies inside each reactor.",
      ...
      {
        prompt: "Now the constraints change. The reaction is strongly autocatalytic (B catalyzes the reaction, so the rate is near zero when little B is present and peaks at intermediate conversion). Does your reactor choice change, and how might a CSTR-plus-PFR arrangement outperform either alone?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Using the Arrhenius relationship, explain why raising temperature speeds up a reaction, and what role the activation energy plays in how sensitive a given reaction's rate is to temperature.",
      ...
      {
        prompt: "Now consider that the desired reaction has a LOWER activation energy than the competing waste reaction. If the team raises temperature to go faster, what happens to selectivity toward D, and what would you recommend instead?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Distinguish between what kinetics and what equilibrium each control here. Explain why raising temperature can actually LOWER the achievable conversion for this exothermic reversible reaction, and what is meant by the concept of an optimal temperature trajectory.",
      ...
      {
        prompt: "Now the constraints change. Suppose you cannot easily lower temperature but you CAN manipulate pressure and product removal. For this reaction where 2 moles of A form 1 mole of B (mole-reducing), what levers shift the equilibrium toward more product, and why does continuously removing B help?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the fundamental tension between conversion and selectivity for this series reaction, and why pushing conversion of A toward completion destroys the yield of R. What does this imply about residence time?",
      ...
      {
        prompt: "Now the constraints change. Compare running this series reaction in a single CSTR versus a single PFR at the residence time that maximizes R in each. Which gives the higher peak yield of R, and why does the mixing behavior matter?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Is the junior engineer correct? Explain what a catalyst changes and what it leaves unchanged, in terms of activation energy, forward and reverse rates, and the equilibrium constant.",
      ...
      {
        prompt: "Now the constraints change. In this packed bed you observe that doubling the temperature barely increases the observed reaction rate, even though the intrinsic chemistry should be much faster. What regime is the reactor likely operating in, and how would you diagnose and fix it?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Explain the mechanism of thermal runaway for an exothermic reaction in terms of how heat generation and heat removal each depend on temperature, and why this creates a positive feedback loop.",
      ...
      {
        prompt: "Now the constraints change. Cooling capacity is fixed and cannot be increased. What design and operating strategies would you use to keep the reactor stable and avoid runaway, and explain why semi-batch (controlled feed addition) is often safer than charging all reactant at once?",
