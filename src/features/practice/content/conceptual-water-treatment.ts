...
export const problems: PracticeProblem[] = [
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain why fine clay particles refuse to settle on their own, and walk through what coagulation and flocculation each do physically to fix that. Be specific about the role of rapid mix versus slow mix.",
      ...
      {
        prompt: "Part 2: Now the constraints change. The plant must keep the same sedimentation basin but the incoming flow rate doubles permanently. Why might settled-water quality degrade, and what levers (chemical and physical) restore it without enlarging the basin?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the purpose of aeration and of return activated sludge in this system, and how solids retention time (sludge age) sets the microbial community. Why does the process depend on the biomass settling well in the clarifier?",
      ...
      {
        prompt: "Part 2: Now the constraints change. Microscopy shows filamentous bacteria dominating and the sludge volume index has spiked (bulking sludge). Why does a rising blanket and effluent solids loss follow, and how would you diagnose and correct the cause rather than just wasting more sludge?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Compare chlorine and UV as disinfectants for this system. Cover mechanism, what the CT concept means, the disinfection byproduct concern, and crucially why distribution distance matters to the choice.",
      ...
      {
        prompt: "Part 2: Now the constraints change. Source monitoring shows recurring Cryptosporidium and the byproduct (THM/HAA) limits are being approached because of high natural organic matter. How should the disinfection strategy change, and why is a single disinfectant likely the wrong answer now?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the physical mechanisms that make a membrane foul or scale, the role of concentration polarization, and how these show up as rising transmembrane pressure and changing salt passage. Distinguish the main fouling types.",
      ...
      {
        prompt: "Part 2: Now the constraints change. The utility wants to push the system to a much higher recovery ratio (more permeate per unit feed) to cut brine disposal cost. Why does higher recovery sharply increase fouling/scaling risk, and what design and operating measures keep it under control?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain why the actual contact time differs from the theoretical detention time (volume/flow), what short-circuiting and dead zones are, and why disinfection credit uses a value like t10 rather than the mean detention time. Contrast plug flow and completely mixed behavior.",
      ...
      {
        prompt: "Part 2: Now the constraints change. You cannot build a larger basin, but you must raise the baffling factor (t10/tau) to earn more CT credit. What physical modifications move the basin toward plug flow, and what are the tradeoffs of each?",
  ...
  },
  {
    ...
    parts: [
      {
        prompt: "Part 1: Explain the job each unit process does and why the order is what it is. In particular, why must coagulation/sedimentation precede filtration, and why is disinfection placed last?",
      ...
      {
        prompt: "Part 2: Now the constraints change. The raw source becomes consistently low in turbidity but high in dissolved natural organic matter (color and DBP precursors). Why might the conventional train underperform, and how would you adapt the process selection?",
